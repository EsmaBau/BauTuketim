...
<head>
    ...
    <title>BAU/Gider Tipi Ekle</title>
    ...
    <link href="css/giderTipiBelirle.css" rel="stylesheet">
    <link href="https://cdn.datatables.net/1.13.7/css/jquery.dataTables.min.css" rel="stylesheet">
</head>
...
<body id="page-top">
                    ...
                    <div class="row">
                        <div class="col-4">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h3 mb-0 text-gray-800" style="font-size: 20px; font-weight: bold;">Gider Türü
                                    Ekle</h1>
                            </div>
                            <!-- Ana Div -->
                            <div style="background-color: white; padding: 20px; border-radius: 10px; width: 400px;">
                                ...
                                <div style="margin-top: 20px;">
                                    <label for="kampusAdi" style="color: black; flex: 1; margin-right: 5px;"><b>Kampüs
                                            Adı:</b></label>
                                    <!-- Kampüs Seçim Inputu -->
                                    <select id="kampusAdi" name="kampusAdi" style="width: 220px;" required></select>
                                </div>

                                <!-- Gider Türü Seçimi -->
                                <div style="margin-top: 20px;">
                                    <label for="giderTuru" style="color: black; flex: 1; margin-right: 16.5px;"><b>Gider
                                            Türü:</b></label>
                                    <!-- Gider Türü Seçim Inputu -->
                                    <input type="text" id="giderTuru" name="giderTuru" style="width: 220px;" required>
                                </div>

                                <!-- Kaydet Butonu -->
                                <div style="margin-top: 20px; display: flex; align-items: center;">
                                    <button type="button" id="kaydetBtn"
                        ...
                        <div class=" align-items-center justify-content-between">
                            <h1 class="h3 text-gray-800" style="font-size: 19px; font-weight: bold;">Giderler</h1>
                        </div>
                        <table id="genelVeri3" class="genelVeri3" style="width:100%">
                            <thead>
                                <tr>
                                    <th style="color: black;">Kampus Adı</th>
                                    <th style="color: black;">Gider Tipi</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel">Gider Tipi Düzenleme</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="container-fluid">
                        <div style="background-color: white; padding: 20px; border-radius: 10px; width: 400px;">
                            ...
                            <form id="kampusForm">
                                <div style="margin-top: 20px;">
                                    <label for="kampusAdi" style="color: black;"><b>Kampus Adı</b></label>
                                    <br>
                                    <!-- Kampüs Seçim Inputu -->
                                    <input type="text" id="editKampusAdi" name="Ad" class="editKampusAdi"
                                        style="width: 300px;" disabled required>
                                </div>
                                <!-- Kampüs Adı Girişi -->
                                <div style="margin-top: 20px;">
                                    <label for="giderTipi" style="color: black;"><b>Gider Tipi</b></label>
                                    <br>
                                    <!-- Kampüs Seçim Inputu -->
                                    <input type="text" id="editGiderTuru" name="Tip" class="Tip" style="width: 300px;"
                                        required>
                                </div>
                                <!-- Kaydet Butonu -->
                                <div style="margin-top: 20px;">
                                    <button type="button" id="editGiderKaydet"
                                        style="background-color: #307dc5; color: white; font-size: 16px; border: none; padding: 10px 20px; border-radius: 5px;">Kaydet</button>
                                </div>
                            </form>
    ...
    <script src="js/giderTipiBelirle.js"></script>
