...
<head>
    ...
    <title>BAU/Tesisat Tanımlama</title>
    ...
    <link href="css/tesisatTanimlama.css" rel="stylesheet">
    <link href="https://cdn.datatables.net/1.13.7/css/jquery.dataTables.min.css" rel="stylesheet">
</head>
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800" style="font-size: 20px; font-weight: bold;">Sayaç Tanımlama</h1>
                    </div>
                    <div style="background-color: white; padding: 20px; border-radius: 10px; width: 400px;">
                        ...
                        <div style="display: flex; flex-direction: row; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                            <!-- Kampüs Adı -->
                            <div>
                                <label for="kampusId" style="color: black;"><b>Kampüs Adı:</b></label>
                            </div>
                            <div>
                                <!-- Kampüs Seçim Inputu -->
                                <select id="kampusId" name="kampusId" required style="width: 232px;"></select>
                            </div>
                        </div>
                        ...
                        <div style="display: flex; flex-direction: row; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                            ...
                            <div>
                                ...
                                <select id="giderTuru" name="giderTuru" required style="width: 232px;"></select>                           
                            </div>
                        </div>
                        ...
                        <div style="display: flex; flex-direction: row; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                            <!-- Sayaç Numarası -->
                            <div>
                                <label for="tesisatNo" style="color: black;"><b>Sayaç Numarası:</b></label>
                            </div>
                            <div>
                                <!-- Sayaç Numarası Inputu -->
                                <input type="number" id="tesisatNo" name="tesisatNo" required style="width: 232px;">
                            </div>
                        </div>
                        
                        <!-- Kaydet Butonu -->
                        <div style="margin-top: 20px;">
                            <button type="button" id="tesisatBtn" style="background-color: #307dc5; color: white; font-size: 16px; border: none; padding: 10px 20px; border-radius: 5px;">Kaydet</button>
                        </div>                   
                    </div>                                                    
                   </div>
                   <div class="col-lg-6 mb-4">
                    <div class="container-fluid">
                        <table id="genelVeri1" class="genelVeri" style="width:100%">
                            <thead>
                                <tr>
                                    <th style="color: black;">Kampüs Adı</th>
                                    <th style="color: black;">Gider Türü</th>
                                    <th style="color: black;">Sayaç Numarası</th>
  ...
  <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
          ...
          <div class="container-fluid">
            <div style="background-color: white; padding: 20px; border-radius: 10px; width: 400px;">
              ...
              <div style="margin-top: 20px;">
                ...
                <br>
                <!-- Kampüs Seçim Inputu -->
                <input id="editKampusId" disabled name="kampusId"  required style="width: 300px;"></input>
              </div>
              <!-- Gider Türü Seçimi -->
              <div style="margin-top: 20px;">
                <label for="giderTuru"  style="color: black;"><b>Gider Türü</b></label>
                <br>
                <!-- Gider Türü Seçim Inputu -->
                <input id="editGiderTuru" disabled name="giderTuru" required style="width: 300px;"></input>
              </div>
              <div style="margin-top: 20px;">
                <label for="tesisatNo" style="color: black;" ><b>Sayaç Numarası</b></label>
                <br>
                <!-- Gider Türü Seçim Inputu -->
                <input type="number" id="editTesisatNox" name="tesisatNo" required style="width: 300px;" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="12">
                <input type="hidden" id="editTesisatIdx"/>
            </div>
              <!-- Kaydet Butonu -->
              <div style="margin-top: 20px;">
                <button type="button" id="editTesisatBtn" style="background-color: #307dc5; color: white; font-size: 16px; border: none; padding: 10px 20px; border-radius: 5px;">Kaydet</button>
              </div>
            </div>
          </div>
        </div>
    ...
    <script src="js/tesisatTanimlama.js"></script>
</body>
</html>